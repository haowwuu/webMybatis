...
public interface AppMapper {
	...
	APPinfo selectById(String appId);
	
	@Select("select * from app_info where app_name = #{appName}")
	@Results({ 
		@Result(property = "appId", column = "app_id"), 
	    @Result(property = "appKey", column = "app_key"), 
	    @Result(property = "appSecret", column = "app_secret"),
	...
	APPinfo selectByAppName(String appName);
	...
	@Select("select count(*) from app_info where app_name = #{appName}")
	int countAppName(String appName);
}
